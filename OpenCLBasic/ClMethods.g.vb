...
Partial Public Module ClMethods
    ...
    <Extension>
    Public Function SetKernelArg(kernel As KernelHandle, argIndex As UInt32, argSize As SizeT) As ClBuffer
        Dim argValue As ClBuffer = Nothing
        Dim errCode = clSetKernelArg(kernel, argIndex, argSize, argValue)
        CheckErr(errCode)
        Return argValue
    End Function
