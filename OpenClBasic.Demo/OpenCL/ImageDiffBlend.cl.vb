...
Public Class ImageDiffBlend
    ...
    Sub New()
        ...
        Using sr As New StreamReader([GetType].GetTypeInfo.Assembly.GetManifestResourceStream("OpenCLBasic.Demo.ImageDiffBlend.cl"), Encoding.UTF8)
    ...
    Public Function Invoke(imageA As Bitmap, imageB As Bitmap) As Bitmap Implements IImageProc.Invoke
        ...
        Using cl = _method.CreateCommandList
            cl.LoadInputImage2D(imageRegion, imageAData.Scan0)
            cl.LoadInputImage2D(imageRegion, imageBData.Scan0)
            cl.LoadOutputImage2D(imageRegion, imageCData.Scan0)
            cl.CallImage2D()
        End Using
