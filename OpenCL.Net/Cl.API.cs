...
namespace OpenCL.Net
{
    ...
    public static partial class Cl
    {
        ...
        private static extern ErrorCode clEnqueueReadBuffer(IntPtr commandQueue,
                                                            ...
                                                            [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 6)] ClEvent[] eventWaitList,
        ...
        private static extern ErrorCode clEnqueueReadImage(IntPtr commandQueue,
                                                           ...
                                                           [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 8)] ClEvent[] eventWaitList,
                                                           [Out] [MarshalAs(UnmanagedType.Struct)] out ClEvent e);
        ...
        private static extern ErrorCode clEnqueueUnmapMemObject(IntPtr commandQueue,
                                                                ...
                                                                IntPtr mappedPtr,
                                                                uint numEventsInWaitList,
                                                                [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 3)] ClEvent[] eventWaitList,
                                                                [Out] [MarshalAs(UnmanagedType.Struct)] out ClEvent e);
        ...
        private static extern ErrorCode clEnqueueTask(IntPtr commandQueue,
                                                      IntPtr kernel,
                                                      uint numEventsInWaitList,
                                                      [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 2)] ClEvent[] eventWaitList,
                                                      [Out] [MarshalAs(UnmanagedType.Struct)] out ClEvent e);
        ...
        private static extern ErrorCode clEnqueueWaitForEvents(IntPtr commandQueue,
                                                               uint numEventsInWaitList,
                                                               [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 1)] ClEvent[] eventWaitList);
        ...
        private static extern ErrorCode clWaitForEvents(uint numEvents,
                                                        [In] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 0)] ClEvent[] eventWaitList);
        ...
        private static extern ErrorCode clGetEventInfo(IntPtr e,
                                                       ...
                                                       IntPtr paramValue,
                                                       out IntPtr paramValueSizeRet);
        public static ErrorCode GetEventInfo(ClEvent e,
                                             EventInfo paramName,
                                             IntPtr paramValueSize,
                                             InfoBuffer paramValue,
                                             out IntPtr paramValueSizeRet)
        ...
        public static ErrorCode RetainEvent(ClEvent e)
        {
        ...
        public static ErrorCode ReleaseEvent(ClEvent e)
        {
        ...
        private static extern ErrorCode clGetEventProfilingInfo(IntPtr e,
                                                                ...
                                                                IntPtr paramValue,
                                                                out IntPtr paramValueSizeRet);
        public static ErrorCode GetEventProfilingInfo(ClEvent e,
                                                      ProfilingInfo paramName,
                                                      IntPtr paramValueSize,
                                                      InfoBuffer paramValue,
                                                      out IntPtr paramValueSizeRet)
