...
namespace OpenCL.Net
{
    public static partial class Cl
    {
        ...
        {
            return CreateBuffer(context, flags, new IntPtr(size), null, out errcodeRet);
        }
        ...
        public static InfoBuffer GetEventInfo(ClEvent e, EventInfo paramName, out ErrorCode error)
        {
        ...
        public static InfoBuffer GetEventProfilingInfo(ClEvent e, ProfilingInfo paramName, out ErrorCode error)
        {
