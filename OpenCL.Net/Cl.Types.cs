...
namespace OpenCL.Net
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct ClEvent : IRefCountedHandle
    {
        private readonly IntPtr _handle;

        internal ClEvent(IntPtr handle)
        {
            _handle = handle;
        }
    ...
    public interface IMem<ChannelOrder, ChannelType>: IMem
    {
    }
    ...
    public struct InfoBuffer : IDisposable
    {
        ...
        public unsafe System.IO.UnmanagedMemoryStream AsStream()
        {
            return new System.IO.UnmanagedMemoryStream((byte*)Address.ToPointer(), Size);
        }
